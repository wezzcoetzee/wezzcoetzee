...
export const CONTACTS: ItemIcon[] = [
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" height="20" width="17.5" viewBox="0 0 448 512" aria-label="LinkedIn">
        <path
          fill="currentColor"
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" height="20" width="19.375" viewBox="0 0 496 512" aria-label="GitHub">
        <path
          fill="currentColor"
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" height="20" width="25" viewBox="0 0 640 512" aria-label="Medium">
        <path
          fill="currentColor"
  ...
  {
    icon: (
      <svg viewBox="0 0 24 24" height="20" width="15" xmlns="http://www.w3.org/2000/svg" aria-label="X (Twitter)">
        <path
          fill="currentColor"
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" height="20" width="16" viewBox="0 0 384 512" aria-label="CV Document">
        <path
          fill="currentColor"
  ...
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" height="20" width="15" viewBox="0 0 384 512" aria-label="Stack Overflow">
        <path
          fill="currentColor"
