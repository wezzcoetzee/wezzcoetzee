export default function Introduction() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-10 md:gap-y-8">
      ...
      <dl
        className="md:col-span-4 md:col-start-9 md:pt-3 md:border-l md:border-border md:pl-6 grid grid-cols-3 md:grid-cols-1 gap-x-6 gap-y-5 text-sm rise-in"
        style={{ animationDelay: '0.25s' }}
      >
        <div>
          <dt className="font-mono text-xs text-muted-foreground tracking-wide mb-1">currently</dt>
